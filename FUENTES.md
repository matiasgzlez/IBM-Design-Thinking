...
Presentación sobre **IBM Enterprise Design Thinking** — Viernes de la Jungla · Agilidad Avanzada · Unidad 1 · 2026.

> 🎬 **¿Querés volver a verla?** La presentación está en este mismo repo:
> [cómo correrla](README.md#-cómo-correrlo). Si está publicada, entrá a la home del sitio.

---

## IBM Enterprise Design Thinking

- [¿Qué es Design Thinking? — IBM Think](https://www.ibm.com/think/topics/design-thinking)
- [Enterprise Design Thinking — IBM Training](https://www.ibm.com/training/enterprise-design-thinking)
- [El framework: principios, Loop y Keys](https://www.ibm.com/training/enterprise-design-thinking/framework) — de acá salen los 3 principios, el Loop y las 3 llaves
- [Badges y certificaciones gratuitas](https://www.ibm.com/design/thinking/page/badges/) — Practitioner (introductorio) y Co-Creator
- [El estudio de Forrester (Total Economic Impact)](https://medium.com/design-ibm/a-new-study-on-design-thinking-is-great-news-for-designers-593f71b40627) — ROI +300%, −75% de tiempo de diseño, 2× time to market
...
- [This is Service Design Doing — métodos](https://www.thisisservicedesigndoing.com/methods) — Stickdorn et al.
- [Design Kit — IDEO.org](https://www.designkit.org/)
